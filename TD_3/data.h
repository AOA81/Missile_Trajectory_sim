...
extern float mxwx[2][5];
extern float mz_detz[2][5];
extern float mx_detx[2][8];
extern float m_beta_x[6][9];
extern float Cx[6][9];
extern float Cz[6][9];
...
extern float cruise_height;

extern float time_climb_to_height;
extern float time_height_to_guiding;
